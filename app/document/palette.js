...
const { rgb_to_hex, hex_to_rbg } = require("../libtextmode/palette");
...
class PaletteChooser extends EventEmitter {
    ...
    update_swatches() {
        ...
        doc.palette.map((rgb, i) => {
            ...
            this.swatch_container_el.appendChild(div);
        });
    ...
    update_selected(level) {
        ...
        selected_el = this.swatch_container_el.querySelector(`div:nth-child(${this[level] + 1})`);
